...
<div class="input-group mb-3">
    <input type="text" class="form-control" placeholder="Cari Karyawan" aria-label="Recipient's username" aria-describedby="button-addon2" name="cari" value="<?= $cari; ?>">
...
<script>
    ...
    function hapus() {
        pesan = confirm('Yakin data karyawan akan dihapus ?');
